...
import useConnectedWeb3 from './useConnectedWeb3'
import useConnectedNetworkId from './useConnectedNetworkId'
...
const useWeb3Modal = () => {
  ...
  const { provider, setProvider } = useConnectedProvider();
  ...
  const providerOptions = {
    ...
    injected: {
      display: {
        ...
        name: "MetaMask",
        description: "Verbinde dich mit Metamask"
      },
      package: null
    },
    // Example with WalletConnect _provider
    walletconnect: {
      display: {
        ...
        name: "WalletConnect",
        description: "Verbinde dich mit einem mobilen Wallet"
      },
